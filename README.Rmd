...
Type `R` in your terminal or (better) just use RStudio R console if you have it. You can either do this on your own laptop (I recommend this option if you have R installed) or on the server you've worked on so far.
