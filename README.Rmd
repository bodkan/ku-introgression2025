...
_Fortunately, you also have genotypes from three other individuals whose identity you know for certain: an African, a Neanderthal, and a chimpanzee. This means that you are able to compute an_ $f_4$ _statistic which will test for evidence of Neanderthal introgression in a given some sample_ $X$.
...
**Create script (`File -> New File -> R Script` in RStudio, or just create it in any other text edit) and save it as `exercise2.R`.**
