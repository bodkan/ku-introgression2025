...
_Fortunately, you also have genotypes from three other individuals whose identity you know for certain: an African, a Neanderthal, and a chimpanzee. This means that you are able to compute an_ $f_4$ _statistic which will test for evidence of Neanderthal introgression in a some sample_ $X$.
